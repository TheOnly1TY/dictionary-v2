export function FontSelector({ dispatch, showFontOptions, fontStyle }) {
  ...
  return (
    ...
    >
      ...
      {showFontOptions && (
        <div
          className="absolute top-[120%] inline-flex flex-col justify-center min-w-[183px] h-[9.5rem] gap-3 p-4 mr-14 text-lg text-primary-CLR dark:text-white bg-white dark:bg-[#1f1f1f] font-bold shadow-drop-shadow dark:shadow-darkmode-drop-shadow rounded-2xl z-20 font_dropdown"
